...
async function cargarInformes() {
  ...
  for (const informe of informesArray) {
    ...
    año.push(datos[0]);
    tipoRecuento.push(datos[1]);
    tipoEleccion.push(datos[2]);
    ...
    try {
      ...
      if (respuesta.ok) {
        ...
        console.log("DATOSSSSS", datosApi);
...
async function mostrarTabla() {
  ...
  for (let i = 0; i < año.length; i++) {
    ...
    const cuadroMesa = document.createElement("div");
    cuadroMesa.classList.add("mesas");

    cuadroMesa.innerHTML = `
    ...
    <div class="contenido">
      <p class="titulo-mesas">Mesas escrutadas</p>
      <p id="porcentaje-mesas">${mesasEscrutadas}%</p>
    </div>
  ...
  `;
    ...
    <svg
                      ...
                      <div class="contenido">
                        ...
                        <p id="porcentaje-elec">${electores}</p>
                      </div>
  ...
  `;
    ...
    <svg
                      ...
                      >
                        ...
                        <path
                          fill="#FFFFFF"
                          d="M328.573,348.25h127.645c4.495,0,8.14,3.645,8.14,8.14l0,0v154.66l0,0H320.552l0,0V356.272
                        ...
                        <path
                          fill="#FFFFFF"
                          d="M657.24,282.422c-1.578-1.706-3.458-3.105-5.544-4.129c-2.162-0.592-4.444-0.592-6.606,0
                        ...
                        <path
                          fill="#FFFFFF"
                          d="M189.368,406.999h81.518c2.867,0,5.19,2.324,5.19,5.191v98.859l0,0h-91.898l0,0V412.19
                      ...
                      <div class="contenido">
                        ...
                        <p id="porcentaje-part">${participacion}</p>
                      </div>

  `;

    contenedorDatosGenerales.appendChild(cuadroMesa);
